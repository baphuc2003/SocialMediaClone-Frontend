...
export function Welcome() {
  ...
  useEffect(() => {
    // Lưu lại đường dẫn trước khi vào trang login
          ...
          <div className="h-full flex flex-col gap-7 justify-center">
            ...
            <div className="btn w-full flex gap-4 flex-col">
              <div className="max-w-[380px]">
                <button className="bg-[#1d9bf0] text-white_#f0f8ff w-full p-2 rounded-3xl hover:bg-[#F3453F] transition-colors duration-300">
                  Tạo tài khoản
                </button>
              </div>
